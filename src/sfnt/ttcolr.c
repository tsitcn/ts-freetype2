...
#define FT_TS_COMPONENT  ttcolr
              ...
              FT_TS_COLR_Paint*  apaint )
  {
    ...
    else if ( apaint->format == FT_TS_COLR_PAINTFORMAT_RADIAL_GRADIENT )
    {
      ...
      apaint->u.radial_gradient.r0 = FT_TS_NEXT_USHORT( p ) << 16;
      ...
      apaint->u.radial_gradient.r1 = FT_TS_NEXT_USHORT( p ) << 16;
                                   ...
                                   FT_TS_ClipBox*  clip_box )
  {
    ...
    for ( i = 0; i < num_clip_boxes; ++i )
    {
      ...
      if ( base_glyph >= gid_start && base_glyph <= gid_end )
      {
        ...
        if ( p1 >= ( (FT_TS_Byte*)colr->table + colr->table_size ) )
          return 0;
